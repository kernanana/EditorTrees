...
//		t.show();
	...
	public void test385ComplexRotationsOnTreeFromSlides() {
		...
		assertEquals(
				...
				t.toDebugString());
		assertTrue(t.ranksMatchLeftSubtreeSize() && t.balanceCodesAreCorrect());
	...
	public void test391ConstructorWithStringNotFullTree() {
		...
		max = maxHeight(t3.size());
		assertTrue(h <= max);
		assertTrue(t1.balanceCodesAreCorrect() && t2.balanceCodesAreCorrect() && t3.balanceCodesAreCorrect());
		m3points += 3 * m3weight;
	}
